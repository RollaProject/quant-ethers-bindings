...
mod safemath_mod {
    ...
    pub static SAFEMATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60808060405234601757603a9081601d823930815050f35b600080fdfe600080fdfea26469706673582212208d1144af5d24c73d6216c7c4f9aef6ca8716aa7fefd5ba39eef76f9a1ae9038064736f6c634300080e0033" . parse () . expect ("invalid bytecode")
        });
    ...
    impl<M: ethers::providers::Middleware> SafeMath<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), SAFEMATH_ABI.clone(), client).into()
        }
