...
mod ecdsa_mod {
    ...
    pub static ECDSA_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60808060405234601757603a9081601d823930815050f35b600080fdfe600080fdfea26469706673582212202dff87e2d72132e2745ead6dee7f97283effde2e844636459ba0111742561a9764736f6c634300080e0033" . parse () . expect ("invalid bytecode")
        });
    pub struct ECDSA<M>(ethers::contract::Contract<M>);
    impl<M> Clone for ECDSA<M> {
        fn clone(&self) -> Self {
            ECDSA(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for ECDSA<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for ECDSA<M> {
    ...
    impl<M: ethers::providers::Middleware> ECDSA<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), ECDSA_ABI.clone(), client).into()
        }
