...
mod console_mod {
    ...
    pub static CONSOLE_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60808060405234601757603a9081601d823930815050f35b600080fdfe600080fdfea2646970667358221220b06b1a014c1ee586b1b6052b4f7d8375d365ee7a3e4145ea6737f40005dd44e464736f6c634300080e0033" . parse () . expect ("invalid bytecode")
        });
