...
mod stdmath_mod {
    ...
    pub static STDMATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60808060405234601757603a9081601d823930815050f35b600080fdfe600080fdfea26469706673582212205542163757adbf92670d1adac353074e19052706b3f67fdc5df46c409494876064736f6c634300080e0033" . parse () . expect ("invalid bytecode")
        });
