...
pub mod signed_converter {
    ...
    impl<M> Clone for SignedConverter<M> {
        fn clone(&self) -> Self {
            SignedConverter(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for SignedConverter<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for SignedConverter<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(SignedConverter))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> SignedConverter<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), SIGNEDCONVERTER_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                SIGNEDCONVERTER_ABI.clone(),
                SIGNEDCONVERTER_BYTECODE.clone().into(),
                client,
            );
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for SignedConverter<M> {
