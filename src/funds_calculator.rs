...
pub mod funds_calculator {
    ...
    impl<M> Clone for FundsCalculator<M> {
        fn clone(&self) -> Self {
            FundsCalculator(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for FundsCalculator<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for FundsCalculator<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(FundsCalculator))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> FundsCalculator<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), FUNDSCALCULATOR_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                FUNDSCALCULATOR_ABI.clone(),
                FUNDSCALCULATOR_BYTECODE.clone().into(),
                client,
            );
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for FundsCalculator<M> {
